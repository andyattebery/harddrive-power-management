...
for drive in "$@"; do
    ...
    # $openseachest_powercontrol_command --device $drive --standby_z enable
    ...
    $openseachest_powercontrol_command --device $drive --idle_a enable
    $openseachest_powercontrol_command --device $drive --idle_b 300000
    $openseachest_powercontrol_command --device $drive --idle_c 600000
    $openseachest_powercontrol_command --device $drive --standby_z 900000
